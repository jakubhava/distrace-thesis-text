...
\begin{enumerate}
	...
	\item Attachment 2: List of the available examples.
	\item Attachment 3: Instructions on how to build and run the Distrace tool.
	\item Attachment 4: List of the native agent arguments.
	\end{enumerate}
\openright

\include{attachement1}
\include{attachement2}
\include{attachement3}
\include{attachement4}
\end{document}
