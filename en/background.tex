...
The sampling of the captured data has also a positive effect on the low-level overhead of the whole application. As mentioned in the paper, the volume of data processed by Google is significant so only samples are taken at a time.
...
Zipkin architecture can bee seen in the Figure \ref{fig:zipkin_architecture}.
\begin{figure}
	\centering
