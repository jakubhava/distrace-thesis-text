...
Javassist is well-known bytecode manipulation library. It allows to Java programs ot define new classes at runtime and also to modify a class file when the JVM loads it.
