...
\end{itemize}
The Zipkin Web user interface is used as a front-end for the monitoring tool developed in the scope of this thesis. More information on how the user interface is used in Distrace tool is described in more details in Section \ref{sec:zipkin_ui}.
 \section{HTrace}
 \label{htrace}
